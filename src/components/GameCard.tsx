    ...
    >
      ...
      <CardBody>
        ...
        <Heading fontSize="2xl" _hover={{filter: 'brightness(0.7)'}}>
          <Link to={"/games/" + game.slug}>{game.name}<Emojis rating={game.rating_top} /></Link>
        </Heading>
        {isExpanded && (
          <Box>
            <Flex
            ...
            >
              <Text fontWeight="bold" color='gray.500'>Release data: </Text>
            ...
            <Flex
              ...
              borderColor="gray.500"
            >
              <Text fontWeight="bold" color='gray.500'>Genres:</Text>
